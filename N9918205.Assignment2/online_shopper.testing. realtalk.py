...
umart_title = findall("goods.php\?id=[0-9]{5}' title='(.*)</a>", umart_data)
...
print create_title(3, umart_title)
print create_img_url(3, umart_img)
print create_price(3, umart_price)

#Find Item, PRice and Image function

##shop_data.write('<!DOCTYPE html>\n')
##shop_data.write('<html>\n')
##shop_data.write('<body>\n')
##
##shop_data.write(' <ul>\n')
##
##html_source = urlopen(umart_page).read()
###umart_element_title = findall('<title>(.*)</title>', html_source)
##umart_element_image = findall('src="/newsite/images/(.*).jpg"', html_source)
##
####umart_element_price = findall('') 
###rss_feed_files.write(str(umart_element_title))
###+ umart_element_image + umart_element_price)                                                        
##print umart_element_image
##
