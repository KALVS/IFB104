...
rss_feeds = ['https://www.etsy.com/shop/littlethingsbyfi/rss', 'https://www.etsy.com/shop/MagM8z/rss', 'https://www.etsy.com/shop/GoodGear69/rss', 'https://www.etsy.com/shop/AestheticsRL.rss ']
...
for feeds in rss_feeds:
    ...
    rss_feed_files.write('    <li>' + extracted_elements[0] + '</li>\n')
